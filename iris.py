#%%
email = 'Irisranchs@gmail.com'
password = 'F12Cclk02gaa23'
Discord = 'ho.ttie'
...
iniciar_navegador(
    tipo_navegador = 'google',
    idioma = 'EN'
)

iniciar_sesion(tipo_inicio = 'automatico',
    email = email,
    password = password
)
...
while True:
    iniciar_envio_de_mensajes_de_respuesta(lista_de_mensajes_de_respuesta = mensajes_de_respuesta,
                                           numero_de_mensajes_de_respuesta_a_enviar = 400)
    
    iniciar_el_envio_del_mensaje_de_presentacion(mensaje_de_presentacion = mensaje_de_presentacion, 
                                                mensajes_de_respuesta = mensajes_de_respuesta,
                                                numero_de_enlaces_a_recorrer = 4, 
